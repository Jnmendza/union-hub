...
import { LayoutDashboard, Users, FileText, Megaphone, LogOut, Settings } from 'lucide-react'
  ...
  return (
    <div className="flex h-screen w-64 flex-col border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
      ...
      <div className="flex h-16 items-center border-b border-slate-200 px-6 dark:border-slate-800">
        <span className="text-lg font-bold text-slate-900 dark:text-white">Union Admin</span>
      </div>
